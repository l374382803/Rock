...
-(void)configUI:(RecordModel *)model
{
    ...
    //计算内容的大小
    CGSize contentSize = [model.text boundingRectWithSize:CGSizeMake(SCREEN_W - 20, CGFLOAT_MAX) options:NSStringDrawingUsesFontLeading | NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:14]} context:nil].size;
    ...
    self.cellHeight = CGRectGetMaxY(_contentLabel.frame) + 10;
